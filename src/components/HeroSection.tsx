  ...
  return (
    <section id="discover" className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-8 items-center px-6 py-16 lg:px-12 lg:py-24">
      <div className="max-w-2xl">
        <span className="inline-block text-xs font-bold uppercase tracking-[0.2em] text-[#ff9a3c] mb-4">
          {t(country,'hero_eyebrow')}
        </span>
        <h1 className="text-5xl lg:text-6xl font-black leading-[1.02] tracking-tight mb-6">
          {t(country,'hero_h1')}
        </h1>
        <p className="text-lg text-[#c4a896] leading-relaxed mb-8 max-w-xl">
          {t(country,'hero_p')}
        </p>
      ...
      <div className="flex justify-center lg:justify-end">
        <div className="w-full max-w-md rounded-[2rem] border border-[rgba(255,154,60,0.15)]
          ...
          <p className="text-[#c4a896] mb-5">Akıllı teknoloji ile günlük bakım bir arada</p>
          <ul className="space-y-3 text-[#c4a896]">
            {[
              ...
              <li key={item} className="flex items-start gap-2">
                <span className="text-[#ff9a3c] mt-0.5 flex-shrink-0">✓</span>
                {item}
              </li>
            ))}
          </ul>
